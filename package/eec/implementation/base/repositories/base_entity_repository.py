...
from eec.core.exceptions import NotFoundException, AlreadyExistsException, ArgumentException
...
class BaseEntityRepository(IEntityRepository):
    ...
    def add_entity(self, entity: EntityModel) -> EntityModel:
        ...
        self._entity_id_to_index[entity.entity_id] = len(self.entities) - 1
        return entity
    ...
    def update_entity(self, entity: EntityModel) -> EntityModel:
        self.calculate_entity_vector(entity)
        if entity.entity_id in self._entity_id_to_index:
            index = self._entity_id_to_index[entity.entity_id]
